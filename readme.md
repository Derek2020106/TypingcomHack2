...
Just click this [link](https://github.com/kgsensei/TypingcomHack2/releases), click on the button that says `typingComInstaller.exe` and go though the software installer. That's it, really, it's that easy.
...
Can reach ~14,400 WPM at ~100% Accuracy.
